#Proportion table code: taken from: http://rnotr.com/likert/ggplot/barometer/likert-plots/
...
data<-read.csv("C:\\Users\\silvi\\OneDrive\\Desktop\\Thesis R\\restraint proportions.csv",header=TRUE)
tab<-data

mytitle<-"Restraint and emotional smoking"
mylevels<-c("Always", "Usually", "About half the time",  "Rarely", "Never")
